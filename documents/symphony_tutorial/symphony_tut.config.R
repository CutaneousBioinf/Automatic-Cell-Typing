...
VariableToGroup="sample_id" ### variable in the metadata to group in symphony variable selection step
...
vars_use = c('sample_id') # Covariants in reference to remove in harmony
